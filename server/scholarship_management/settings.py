...
SECRET_KEY = 'django-insecure-=*u33&%#jqa*xrw0ty!)5!p$bnnd*f*n)s_g7-79u_tda_*_id'
...
# Pour le développement, vous pouvez également autoriser toutes les méthodes HTTP
CORS_ALLOW_METHODS = [
    "DELETE",
    "GET",
    "OPTIONS",
